...
const OPTIONAL: Record<string, string[]> = {
  ...
  TxnCounterparty: ['urduName', 'institutionLogoUrl'],
  InstitutionRef: ['urduName', 'logoUrl'],
  InstitutionChip: ['urduName', 'logoUrl'],
  RecipientCard: ['linkedUserId'],
  RecipientChip: ['institutionLogoUrl'],
  BillerChip: ['savedBillerId', 'urduName', 'consumerNo', 'logoUrl'],
  SavePromptCard: ['institutionId', 'identifier', 'title', 'billerId', 'consumerNo', 'consumerName'],
  BillCard: ['billerLogoUrl'],
  BillItem: ['billerLogoUrl'],
